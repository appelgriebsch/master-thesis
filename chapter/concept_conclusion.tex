...
In the following Chapter~\ref{cha:system_design} the Master thesis will come up with an approach that uses the fundamental technologies from the Semantic Web for information sharing and integration as well as peer-to-peer communication technologies for securing and restricting access to the \gls{RDF} data sets from relevant participants of the \gls{E-commerce} fraud investigation scenario.
