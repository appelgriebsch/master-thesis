...
\begin{enumerate}
	...
	\item existing technological solutions to detect and prevent them will not be able to cover 100\% due to limitations in time and efforts required for verification,
	\item a substantial analysis of suspicious transactions are not taken place today due to the enormous effort and time needed to collect all required information manually
\end{enumerate}
