...
This Master thesis started with two major premises: \@

\begin{itemize}
	\item the use of an electronic transfer of credit card information in the \gls{E-commerce} scenario make them always subject to counterfeits,
	\item a substantial analysis of suspecious transactions are not taken place today due to the enormous effort and time needed to collect all required information manually
\end{itemize}
