...
\begin{listing}[H]
  ...
  \caption{Specifying a link to Geo Names resources for additional location information in \gls{RDF}}
...
\begin{listing}[H]
  ...
  \caption{Specifying a link to DBpedia resources to uniquely identify an entity in \gls{RDF}}
