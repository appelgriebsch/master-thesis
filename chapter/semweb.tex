...
\begin{itemize}
	...
	\item \textbf{FILTER:} express additional filter conditions on the result set of a \gls{SPARQL} query; e.g.\ FILTER(?releaseDate > ``1980-01-01'')
...
\begin{listing}[H]
	\begin{minted}[linenos,
		...
		# here: there is an entity of class dc:Sound that have a title
		CONSTRUCT {
